...
# ============================================================
# [사용법]
# v3 이원화 2단계 파인튜닝 (부분 unfreeze + 차등 lr + cosine + AMP).
# 반드시 train_binclf_v3.py를 같은 ARCH/RUN_NAME으로 먼저 실행해야 합니다.
#
# 실행 (런팟 = 리눅스):
#   ARCH=resnet50 RUN_NAME=v3r50a NUM_EPOCHS=15 python src/v3/fine_tune_binclf_v3.py
# (PowerShell):
#   $env:ARCH="resnet50"; $env:RUN_NAME="v3r50a"; python src/v3/fine_tune_binclf_v3.py
#
...
from pipeline_v3 import run_fine_tune
