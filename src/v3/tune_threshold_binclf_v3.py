...
# ============================================================
# [사용법]
# v3 이원화 임계값 튜닝 (선택 단계). GPU가 없어도 됩니다 (추론 2회뿐).
#
...
#
# 실행 (런팟 = 리눅스):
#   ARCH=resnet50 RUN_NAME=v3r50a python src/v3/tune_threshold_binclf_v3.py
# (PowerShell):
#   $env:ARCH="resnet50"; $env:RUN_NAME="v3r50a"; python src/v3/tune_threshold_binclf_v3.py
#
# [환경변수] ARCH RUN_NAME EVAL_TARGET(finetuned) RECALL_FLOOR(0.85) — README 참고
#
# 결과 (test_results/binclf_v3/<ARCH>/<RUN_NAME>_threshold/):
...
def main():
    ...
    output_dir = test_results_root / "binclf_v3" / ARCH / f"{RUN_NAME}_threshold"
