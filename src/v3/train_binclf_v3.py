...
# ============================================================
# [사용법]
# v3 이원화(우수 vs 불량) 1단계 baseline 학습 (head만, ImageNet 가중치).
#
# 실행 (런팟 = 리눅스):
...
#   DATA_DIR / LIMIT_PER_SPLIT(스모크 전용) — 상세는 src/v3/README.md
#
# 결과:
...
#   ARCH=resnet50 RUN_NAME=v3r50a python src/v3/fine_tune_binclf_v3.py
# ============================================================

from pipeline_v3 import run_train
